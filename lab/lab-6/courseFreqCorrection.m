function ReturnedSymbol = courseFreqCorrection(inputSignal, timeIndex, modulationOrder, sampleRate, frameSize, numFrames, filterUpsample)
...
ReturnedSymbol = inputSignal(timeIndex) .* freqShift;
